...
Here's the <a href="https://github.com/amjadya/rl-arm-tracking/blob/main/archive/pd_demo.py" target="_blank" rel="noopener noreferrer">GitHub link</a>, and here are some videos:
